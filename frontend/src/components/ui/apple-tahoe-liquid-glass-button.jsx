      ...
      <>
        ...
        <style>{`
          .btn-liquid {
            ...
            /* Use a fallback color if foreground variable is missing */
            color: oklch(from var(--foreground, #FEFEFE) l c h / 95%);
            --glass-reflex-light: 1;
            --glass-reflex-dark: 1;
          }

          .btn-liquid-lens {
            background-color: ${glassColor || "oklch(from var(--foreground, #0D0D0D) l c h / 5%)"};
          ...
          .btn-liquid-text {
            text-shadow: 0 1px 2px oklch(from var(--background, #000000) l c h / 30%);
